...
export class BalanceController {
   ...
   * Get current balance
   */
  static async getBalance(_req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  static async updateBalance(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
