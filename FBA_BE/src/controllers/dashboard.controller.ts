...
export class DashboardController {
   ...
   */
  static async getCategoryUtilisation(_req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  static async getSpendingTrend(_req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  static async getPlannedVsActual(_req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
   ...
   */
  static async getProjectedBalances(_req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
