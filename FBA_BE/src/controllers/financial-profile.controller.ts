...
export class FinancialProfileController {
   ...
   */
  static async getProfile(_req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
  ...
  static async update(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      const profile = financialProfileService.updateProfile(data as any);
   ...
   */
  static async getRemainingDays(_req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
