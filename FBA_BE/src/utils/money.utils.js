 ...
 */
export function ringgiitToCents(amount): number {
 ...
 */
export function centsTToRinggit(cents): number {
 ...
 */
export function formatCentsAsRinggit(cents): string {
 ...
 */
export function addCents(a, b): number {
 ...
 */
export function subtractCents(a, b): number {
 ...
 */
export function divideCents(a, b): number {
  if (b === 0) return 0;
 ...
 */
export function multiplyCents(a, b): number {
 ...
 */
export function percentageOfCents(percentage, total): number {
 ...
 */
export function centsAsPercentage(value, total): number {
  if (total === 0) return 0;
 ...
 */
export function ensureNonNegative(cents): number {
 ...
 */
export function roundCents(cents): number {
 ...
 */
export function centsEqual(a, b, tolerance= 0): boolean {
