 ...
 * 
 * Storage: 1500.50 RM is stored as 150050 cents
 * Display: 150050 cents is displayed as RM1,500.50
 */
 ...
 */
export function ringgiitToCents(amount: number | string): number {
 ...
 */
export function centsTToRinggit(cents: number): number {
 ...
 */
export function formatCentsAsRinggit(cents: number): string {
 ...
 */
export function divideCents(a: number, b: number): number {
  if (b === 0) return 0;
 ...
 */
export function multiplyCents(a: number, b: number): number {
 ...
 */
export function percentageOfCents(percentage: number, total: number): number {
 ...
 */
export function centsAsPercentage(value: number, total: number): number {
  if (total === 0) return 0;
 ...
 */
export function ensureNonNegative(cents: number): number {
 ...
 */
export function centsEqual(a: number, b: number, tolerance: number = 0): boolean {
